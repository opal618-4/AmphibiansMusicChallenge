...
import americanBullfrogImg from '/assets/images/american-bullfrog.png'
import pacificTreeFrogImg from '/assets/images/pacific-tree-frog.png'
...
export const frogs: FrogSpecies[] = [
  {
    ...
    habitat: 'Although found on the tundra in the north and occasionally in grasslands in the west, the wood frog is most commonly associated with moist woodlands and vernal woodland pools. When inactive, this frog hides in logs, humus and leaf litter or under logs and rocks. It hibernates under logs or leaf litter on the forest floor.',
  ...
  },
  {
    ...
    habitatImage: poisonDartFrogImg,
  ...
  },
  {
    ...
    habitatImage: americanBullfrogImg,
  ...
  },
  {
    ...
    image: pacificTreeFrogImg,
    habitatImage: pacificTreeFrogImg,
